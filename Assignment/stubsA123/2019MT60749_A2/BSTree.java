...
public class BSTree extends Tree {
    ...
    public boolean Delete(Dictionary e)
    {
        ...
        while(current!=null)
        {
            if(current.key==e.key&&current==e)
            {
                ...
                else
                {
                    ...
                    while(succ.left!=null)
                        succ = succ.right;
                    int tempo1 = succ.key,tempo2 = succ.address,tempo3 = succ.size;
                    succ.key = current.key;succ.address = current.address;succ.size = current.size;
                    current.key = tempo1;current.address = tempo2;current.size = tempo3;
